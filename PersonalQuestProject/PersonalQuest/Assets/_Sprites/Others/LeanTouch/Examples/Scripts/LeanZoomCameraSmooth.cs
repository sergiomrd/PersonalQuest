...
namespace Lean.Touch
{
	...
	public class LeanZoomCameraSmooth : MonoBehaviour
	{
        ...
        [Tooltip("The camera we will be moving and Rendering")]
        ...
        protected virtual void Start()
		{
			if (LeanTouch.GetCamera(ref Camera) == true)
			{
                ...
                OutlineCamera = Camera.GetComponentInChildren<Camera>();
                Target = GetCurrent();
			}
		}
		...
		protected virtual void LateUpdate()
		{
			...
			if (LeanTouch.GetCamera(ref Camera) == true)
			{
                ...
                OutlineCamera = Camera.FindObjectOfType<Camera>();

                Camera.projectionMatrix = Matrix4x4.Ortho(
                -current * aspect, current * aspect,
                -current, current,
                Camera.nearClipPlane, Camera.farClipPlane);

                OutlineCamera.projectionMatrix = Camera.projectionMatrix;
